...
/**
 * This is the item provider adapter for a {@link eaeu.cm.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationItemProvider extends GlobalElementItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Relation_ends_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Relation_ends_feature", "_UI_Relation_type"),
                 CMPackage.Literals.RELATION__ENDS,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(CMPackage.Literals.RELATION__ENDS);
        }
    ...
    public String getText(Object object) {
        String label = ((Relation)object).getLabel();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (CMPackage.Literals.RELATION__ENDS,
                 CMFactory.eINSTANCE.createRelationEnd()));
    }
